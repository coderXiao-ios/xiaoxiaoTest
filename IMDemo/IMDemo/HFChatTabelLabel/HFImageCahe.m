...
//  IMDemo
//
//  Created by 潇潇 on 16/9/30.
//  Copyright © 2016年 潇潇. All rights reserved.
//

#import "HFImageCahe.h"
#import <CommonCrypto/CommonDigest.h>

@interface HFImageCahe (){
    NSFileManager *_fileManager;
}

@end
@implementation HFImageCahe
static HFImageCahe *_instance;
...
{
    return [self.localDirectory stringByAppendingPathComponent:[HFImageCahe md5:imageName]];
}
